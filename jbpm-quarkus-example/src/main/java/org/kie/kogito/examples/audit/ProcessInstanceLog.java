...
public class ProcessInstanceLog implements Serializable, AuditEvent, org.kie.api.runtime.manager.audit.ProcessInstanceLog {
    ...
    private List<NodeInstanceLog> nodes;
    ...
    public String toString() {
        return "ProcessInstanceLog{" +
                "CORRELATION_KEY_LOG_LENGTH=" + CORRELATION_KEY_LOG_LENGTH +
                ", id=" + id +
    ...
    public List<NodeInstanceLog> getNodes() {
        return nodes;
    }

    public void setNodes(List<NodeInstanceLog> nodes) {
        this.nodes = nodes;
    }
